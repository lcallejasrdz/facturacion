        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(['url' => 'simples-movements/create-facturations', 'method' => 'post', 'id' => 'form-create', 'files' => true]) }}
                        {{ Form::token() }}
                        @include('operations.simples-movements.forms.simple-movement-facturations')
...
@section('scripts')
    {{ Html::script('assets/js/operations/simples-movements/create-facturations.js') }}
@endsection
