        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(['url' => 'simples-movements/outputs-receipts', 'method' => 'post', 'id' => 'form-facturation', 'files' => true]) }}
                        {{ Form::token() }}
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <thead>
...
@section('scripts')
    {{ Html::script('assets/js/operations/simples-movements/outputs-receipts.js') }}
@endsection
