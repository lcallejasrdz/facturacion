        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(['url' => 'payrolls-movements/facturations-payment', 'method' => 'post', 'id' => 'form-facturation', 'files' => true]) }}
                        {{ Form::token() }}
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <thead>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        {{ link_to('payrolls-movements/'. $movement->id .'/facturations-rollback', 'Regresar a Facturación', ['id' => 'rollback-btn', 'class' => 'btn btn-primary']) }}
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    {{ Html::script('assets/js/operations/payrolls-movements/facturations-payment.js') }}
@endsection
