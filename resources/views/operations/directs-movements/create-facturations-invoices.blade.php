        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(['url' => 'directs-movements/create-facturations-invoices', 'method' => 'post', 'id' => 'form-create', 'files' => true]) }}
                        {{ Form::token() }}
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <thead>
...
@section('scripts')
    {{ Html::script('assets/js/operations/directs-movements/create-facturations-invoices.js') }}
@endsection
