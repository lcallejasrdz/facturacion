        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if($movement->status == 'Administrador - Facturación')
                        {{ link_to('directs-movements/'. $movement->id .'/movement-rollback', 'Eliminar Movimiento', ['id' => 'rollback-btn', 'class' => 'btn btn-primary']) }}
                    @else
                        {{ link_to('directs-movements/'. $movement->id .'/movement-rollback', 'Regresar Movimiento', ['id' => 'rollback-btn', 'class' => 'btn btn-primary']) }}
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalRollbackPayment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    {{ link_to('directs-movements/'. $movement->id .'/delete-payment-entry', 'Eliminar Pagos', ['id' => 'rollback-btn-payment', 'class' => 'btn btn-primary']) }}
                </div>
            </div>
        </div>
    </div>
